...
![큐 대표 이미지](./assets/queue/Queue-Data-structure.png)
...
![원형 큐 이미지](./assets/queue/Circular-queue.png)

    보통 배열로 구현하고,배열을 순환 구조로 사용하여 공간 낭비 최소화한다.

## 3. 우선순위 큐 (Priority Queue)

![우선순위 큐 이미지](./assets/queue/pr_queue.png)
